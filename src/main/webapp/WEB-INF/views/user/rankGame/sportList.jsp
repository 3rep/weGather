...
<div class="game_container">
	<div class="game_type_container rank">
		<span class="game_type_desc"><img src="/static/img/imgMain/quoteLeft.png"/>랭크경기는 매니저 주관 하에 참여자의 실력이 평가되는 아마추어 경기입니다.<img src="/static/img/imgMain/quoteRight.png"/></span>
	</div>
	<ul class="sport_list">
