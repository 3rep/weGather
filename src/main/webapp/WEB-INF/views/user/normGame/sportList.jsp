...
<div class="game_nav norm_game_nav"><b>종목선택</b> > 경기목록 > 경기상세정보</div>
<div class="game_container">
	<div class="game_type_container">
		<span class="game_type_desc">일반경기는 매니저 없이 사용자가 자유롭게 개설할 수 있습니다.<br/></span>
	</div>
	<ul class="sport_list">
