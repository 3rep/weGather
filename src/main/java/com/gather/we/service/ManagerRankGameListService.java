...
public interface ManagerRankGameListService {
	public List<ManagerRankGameListDTO> rankGameListAllSelect(MRankGameListCriteria criteria);//랭크게임 리스트, 페이징

	public int updateApply(ManagerRankGameDTO rankGameDTO) throws Exception;//랭크게임 신청
	
	public int getTotalCount(MRankGameListCriteria criteria);//랭크게임 레코드 수
